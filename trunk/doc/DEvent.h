...
class DEventHeader  {
 ...
 public:
  ...
  void           Set(const Int_t aNEvent, 
		     ...
		     const Int_t aTime, 
		     const Int_t aType,
		     vector<int> *aListOfTriggers=NULL,
		     vector<int> *aListOfFrames=NULL,
		     vector<int> *aListOfTimestamps=NULL);
...
class DEvent : public TObject {
 public:
  ...
  void             AddTransparentPlane(DPlane& aPlane, DTrack& aTrack, DHit& aHit, Bool_t hitAssociated); // modified JB 2014/08/29
...
class DTransparentPlane : public TObject {
 ...
 public:
  ...
  DTransparentPlane(DPlane& aPlane, DTrack& aTrack, DHit& aHit, Bool_t hitAssociated);
