...
//  Float_t geomVmin, geomVmax;
  ...
  void    CreateNewEta();
  Bool_t  TrackInMimo( Int_t aGeoMatrix, Float_t tuVal, Float_t tvVal);
  ...
  // JB 2010/07/22
  void FakeRate_init(){;}
  void FakeRate_compute(DAuthenticHit *thehit) {;}
  void FakeRate_fill(DAuthenticHit *thehit) {;}
 ...
 public:
  ...
  void       SetDSFFile(Char_t *aFileName) {sprintf( RootFile, "%s", aFileName);}; // JB 2013/09/19
  ...
  void       InitCorPar(Int_t aRun, Int_t aPlane, Char_t *objType="plane"); // JB 2014/02/10
 ...
 void       PrepareRun(int RunNumberBigin, Option_t* aType,int NumberOfFilesPerRun=0, int RunNumberEnd=0, int RunNumberStep=1 );
  ...
  void       InitSession(const Int_t TheRun,const unsigned int ThePlane=0, Int_t EventBuildingMode=-1,TString ConfigFile=""); 
  ...
  void       AlignTracker(const Float_t tiniBoundU, const Float_t tiniBoundV, Int_t nAlignEvents=4000, Int_t nAdditionalEvents=2000); // 2013/06/10
  void       AlignTracker(const Float_t tiniBound = 480., Int_t nAlignEvents=4000, Int_t nAdditionalEvents=2000) { AlignTracker( tiniBound, tiniBound, nAlignEvents, nAdditionalEvents); }
  void       AlignTrackerMinuit(Bool_t modeAuto=1, const Float_t tiniBound=480., Int_t nAlignEvents=5000, Int_t nAlignHitsInPlane=4000, Int_t nAdditionalEvents=2000, Double_t chi2Limit=0.); // LC 2012/09/06
  void       AlignTrackerMinuitLadder(Bool_t modeAuto =1, const Float_t tiniBound=480., Int_t nAlignEvents=5000, Int_t nAlignHitsInPlane=4000, Int_t nAdditionalEvents=2000, Double_t chi2Limit=0.);
  ...
  void       AlignLadderMV(Bool_t modeAuto=1, const Float_t tiniBound=480., Int_t nAlignEvents=5000, Int_t nAdditionalEvents=2000, Int_t chi2Limit=40); // LC 2013/11/10
...
//  void        Gener(Double_t* xp, Double_t* yp, Double_t& aX, Double_t& bX, Double_t& aY, Double_t& bY, Double_t* sigX, Double_t* disX, Double_t* sigY, Double_t* disY, Double_t* z, Double_t* phi); // LC 2012/01/07
  ...
  MRaw*      GetRaw();
  MRax*      GetRax();
  void       MimosaPro(Int_t MaxEvt, Int_t TrackHitDist, Float_t S2N_seed, Float_t S2N_neighbour, Int_t submatrix, Int_t GeoMatrix, Option_t*  SaveAlign, Int_t UseHitMap=0, Int_t WriteMissedHits=0, Int_t WriteGoodHits=0);
