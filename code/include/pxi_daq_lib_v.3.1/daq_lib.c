...
// 2015/07/21, JB: cleaning of definitions for DATA_FORMAT_CC1 & CC2
...
#ifdef CC_64B
  msg (( MSG_OUT, "= Compiled for  64 bits system" ));
#else
  msg (( MSG_OUT, "= Compiled for  32 bits system" ));
#endif
  msg (( MSG_OUT, "============================================================" ));
...
SInt32 APP__FLoadRun ( char* RunDir, char* RunPrefix, SInt32 RunNo ) {
...
#ifdef CC_64B
  VRet = VRet | APP__VGRunConfFile.PubFConf ( VPtCont->InfRunParFile, FIL__TCBinFile_RWB_MODE_READ, 1628/*sizeof (EFRIO__TRunCont)*/,1628/* sizeof (EFRIO__TRunCont)*/, 0 /* FlushAfterWrite */, 0 /* MeasTime */ );
  VRet = VRet | APP__VGRunConfFile.PubFOpen ();
  VRet = VRet | APP__VGRunConfFile.PubFSeqRead ( &VPtCont->ResRunCont,1628/* sizeof (EFRIO__TRunCont)*/, 1628/*sizeof (EFRIO__TRunCont)*/ );
#else  
  ...
  VRet = VRet | APP__VGRunConfFile.PubFOpen ();
  VRet = VRet | APP__VGRunConfFile.PubFSeqRead ( &VPtCont->ResRunCont, sizeof (EFRIO__TRunCont), sizeof (EFRIO__TRunCont) );
#endif
...
/* DOC_FUNC_BEGIN */
/* ===================================================================================
Prototype : SInt32 APP__FAllocAcqBuffer (SInt8 MapsName )
          :
...
SInt32 APP__FAllocAcqBuffer (SInt8 MapsName) {
  ...
  switch (MapsName){
	case ASIC__MI26:{
	  ...
	  printf("VPtCont->InfMaxFrameSz = %d\n",VPtCont->InfMaxFrameSz);
	  printf("sizeof ( EFRIO__TFrame )               = %d\n",sizeof ( EFRIO__TFrame ));
	  printf("VPtCont->ResRunCont.ParMi26Nb          = %d\n",VPtCont->ResRunCont.ParMi26Nb);
	  printf("MI26__ZS_FFRAME_RAW_MAX_W8             = %d\n",MI26__ZS_FFRAME_RAW_MAX_W8);
	  printf("sizeof ( EFRIO__TTriggerRec )          = %d\n",sizeof ( EFRIO__TTriggerRec ));
	  printf("EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB = %d\n",EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB);
	  printf("EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ     = %d\n",EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ);
	break;
	}
	case ASIC__ULT1:{
	  printf("ASIC__ULT1\n");
	  VPtCont->InfMaxFrameSz          = ( sizeof ( EFRIO__TFrame ) + ( VPtCont->ResRunCont.ParMi26Nb * ULT1__ZS_FFRAME_RAW_MAX_W8 ) + sizeof ( EFRIO__TTriggerRec ) + (EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB * EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ) );
	  printf("VPtCont->InfMaxFrameSz                 = %d\n",VPtCont->InfMaxFrameSz);
	  printf("sizeof ( EFRIO__TFrame )               = %d\n",sizeof ( EFRIO__TFrame ));
	  printf("VPtCont->ResRunCont.ParMi26Nb          = %d\n",VPtCont->ResRunCont.ParMi26Nb);
	  printf("ULT1__ZS_FFRAME_RAW_MAX_W8             = %d\n",ULT1__ZS_FFRAME_RAW_MAX_W8);
	  printf("sizeof ( EFRIO__TTriggerRec )          = %d\n",sizeof ( EFRIO__TTriggerRec ));
	  printf("EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB = %d\n",EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB);
	  printf("EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ     = %d\n",EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ);
	break;
	...
	default:{
	  printf("DEFAULT\n");
	  err_retfail ( -1, (ERR_OUT,"Abort : unknown asic n :%d !", MapsName) );
...
SInt32 APP__FAllocAcqBuffer () {
  ...
  // Calculates sizes
  // ----------------------
  // 19 11 14 - MS changed MI26__ZS_FFRAME_RAW_MAX_W8 to ULT1__ZS_FFRAME_RAW_MAX_W8 because the size of the allocated buffer was too small for 14 chips  
  VPtCont->InfMaxFrameSz          = ( sizeof ( EFRIO__TFrame ) + ( VPtCont->ResRunCont.ParMi26Nb * ULT1__ZS_FFRAME_RAW_MAX_W8 ) + sizeof ( EFRIO__TTriggerRec ) + (EFRIO__EXTRA_CHAN__MAX_TRIGGER_INFO_NB * EFRIO__EXTRA_CHAN__TRIGGER_INFO_SZ) );
  VPtCont->ResRunCont.InfFrameBuffSz = VPtCont->ResRunCont.ParFrameNbPerAcq * VPtCont->InfMaxFrameSz;
...
{    
  ...
  msg  (( MSG_OUT, "sizeof (char) = %d", sizeof (char) ));
  msg  (( MSG_OUT, "sizeof (SInt8) = %d", sizeof (SInt8) ));
  msg  (( MSG_OUT, "sizeof (UInt8) = %d", sizeof (UInt8) ));
  msg  (( MSG_OUT, "sizeof (SInt16) = %d", sizeof (SInt16) ));
  msg  (( MSG_OUT, "sizeof (UInt16) = %d", sizeof (UInt16) ));
  msg  (( MSG_OUT, "sizeof (SInt32) = %d", sizeof (SInt32) ));
  msg  (( MSG_OUT, "sizeof (UInt32) = %d", sizeof (UInt32) ));
  msg  (( MSG_OUT, "sizeof (UInt64) = %d", sizeof (UInt64) ));
  msg  (( MSG_OUT, "sizeof (int) = %d", sizeof (int) ));
  msg  (( MSG_OUT, "sizeof (long) = %d", sizeof (long) ));
  msg  (( MSG_OUT, "sizeof (float) = %d", sizeof (float) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrame) = %d", sizeof (EFRIO__TFrame) ));
  msg  (( MSG_OUT, "sizeof (MI26__TZsFFrameRaw) = %d", sizeof (MI26__TZsFFrameRaw) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrame*) = %d", sizeof (EFRIO__TFrame*) ));
  msg  (( MSG_OUT, "sizeof (MI26__TZsFFrameRaw*) = %d", sizeof (MI26__TZsFFrameRaw*) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrame*) = %d", sizeof (EFRIO__TFrame*) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrameHeader*) = %d", sizeof (EFRIO__TFrameHeader*) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrameData*) = %d", sizeof (EFRIO__TFrameData*) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrameHeader) = %d", sizeof (EFRIO__TFrameHeader) ));
  msg  (( MSG_OUT, "sizeof (EFRIO__TFrameData) = %d", sizeof (EFRIO__TFrameData) ));
  
  msg  (( MSG_OUT, " EFRIO__MAX_DATA_FILE_BLOC_SZ = %d", EFRIO__MAX_DATA_FILE_BLOC_SZ ));
  
  
  
  
  //msg  (( MSG_OUT, "sizeof (u32) = %d", sizeof (u32) ));
...
//  VRet = APP__FLoadRun ( "/Projets/Caract_test/tmp/mi28_bt_run_file_format_var_length_040214__template_run/288001" /* RunDir */, "RUN_" /* RunPrefix */, 288001 /* RunNo */ );
  //VRet = APP__FLoadRun ( "/Projets/Caract_test/tmp/fsbb0_lab_test_runs/35402" /* RunDir */, "RUN_" /* RunPrefix */, 35402 /* RunNo */ );
  //VRet = APP__FLoadRun ( "/Projets/Caract_test/tmp/Desy_salat_11_2014/28011" /* RunDir */, "RUN_" /* RunPrefix */, 28011 /* RunNo */ );
  ...
  // -----------------------------
#ifdef APP_NEW_BUFFER_ALLOC
  APP__FAllocAcqBuffer (ASIC__ULT1);
#else  
