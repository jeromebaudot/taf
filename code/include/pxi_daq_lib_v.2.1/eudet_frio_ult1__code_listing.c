  ...
  */
  ...
  for ( ViFrameWithTrig=0; ViFrameWithTrig < VFrameWithTrigCnt; ViFrameWithTrig++ ) {
    ...
    switch ( VPtDataTest->ParTestType ) {
      ...
      case 1 : {
        EFRIO__ULT1_FChkFrameLight ( 0 /* FuncId */ , ViFrameWithTrig, VPtFrame, 8 /* Mi26Nb */ );
        break; }
      
      case 2 : {
        EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailer ( 0 /* FuncId */ , VPtFrame, ViFrameWithTrig, 8 /* Mi26Nb */, VPtFrList->AFramePtr[0]->Header.AMapsFrameCnt[0] /* FrameCntOfFirstFrameOfAcq */ ); // 23/01/2014 : For timing tests at lab
        break; }
            
      case 3 : {
        EFRIO__ULT1_FChkFrameHeaderFrameCntCmpTrailerMatrix ( 0 /* FuncId */ , VPtFrame, 8 /* Mi26Nb */ ); // 24/01/2014 : For timing tests at lab
        break; }
      
      case 4 : {
        EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailerMatrix ( 0 /* FuncId */ ,  VPtFrame, ViFrameWithTrig, 8 /* Mi26Nb */, VPtFrList->AFramePtr[0]->Header.AMapsFrameCnt[0] /* FrameCntOfFirstFrameOfAcq */ ); // 24/01/2014 : For timing tests at lab
        break; }
          
      case 5 : {
        EFRIO__ULT1_FCheckTFrame ( VPtFrame, 0 /* EmulErr */ );
        EFRIO__ULT1_FChkFrameHeaderFrameCntCmpTrailerMatrix ( 0 /* FuncId */ , VPtFrame, 8 /* Mi26Nb */ ); // 24/01/2014 : For timing tests at lab
        break; }
      
      case 6 : {
        EFRIO__ULT1_FCheckTFrame ( VPtFrame, 0 /* PrintLevel */ );
        break; }
      
      case 7 : {
        EFRIO__ULT1_FCheckTFrame ( VPtFrame, 1 /* EmulErr */ );
        EFRIO__ULT1_FChkFrameHeaderFrameCntCmpTrailerMatrix ( 0 /* FuncId */ , VPtFrame, 8 /* Mi26Nb */ ); // 24/01/2014 : For timing tests at lab
        break; }
