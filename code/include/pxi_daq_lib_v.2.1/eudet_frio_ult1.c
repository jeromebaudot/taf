...
SInt32 EFRIO__ULT1_FTestOnDataGetJtagRef () {
  ...
  //  ParAMatPatternLineNb
    
  VJtagFileName = FIL_FExtractFileNameFromFilePath (VPtRunCont->ParJtagFileName);
  
  msg (( MSG_OUT, "JTAG file name = %s", VJtagFileName ));
  
  while (1) {
    
    if ( strcmp (VJtagFileName, "MI28_2x160Mhz_suze_lpa.mcf") ) {
      VPtTestCont->ParAMatPatternLineNb[0] = 928;
      VPtTestCont->ParAMatPatternLineNb[1] = 928;
      VPtTestCont->ParAMatPatternLineNb[2] = 928;
      VPtTestCont->ParAMatPatternLineNb[3] = 928;
      VPtTestCont->ParAMatPatternLineNb[4] = 928;
      VPtTestCont->ParAMatPatternLineNb[5] = 928;
      VPtTestCont->ParAMatPatternLineNb[6] = 928;
      VPtTestCont->ParAMatPatternLineNb[7] = 928;
      break;
    }
    
    if ( strcmp (VJtagFileName, "MI28_2x160Mhz_suze_lpb.mcf") ) {
      VPtTestCont->ParAMatPatternLineNb[0] = 928;
      VPtTestCont->ParAMatPatternLineNb[1] = 928;
      VPtTestCont->ParAMatPatternLineNb[2] = 928;
      VPtTestCont->ParAMatPatternLineNb[3] = 928;
    ...
    if ( strcmp (VJtagFileName, "MI28_2x160Mhz_suze_lpc.mcf") ) {
      VPtTestCont->ParAMatPatternLineNb[0] = 928;
      VPtTestCont->ParAMatPatternLineNb[1] = 928;
      VPtTestCont->ParAMatPatternLineNb[2] = 928;
      VPtTestCont->ParAMatPatternLineNb[3] = 928;
    ...
    if ( strcmp (VJtagFileName, "MI28_2x160Mhz_suze_lpd.mcf") ) {
      VPtTestCont->ParAMatPatternLineNb[0] = 928;
      VPtTestCont->ParAMatPatternLineNb[1] = 928;
      VPtTestCont->ParAMatPatternLineNb[2] = 928;
      VPtTestCont->ParAMatPatternLineNb[3] = 928;
    ...
    if ( strcmp (VJtagFileName, "MI28_2x160Mhz_suze_lpe.mcf") ) {
      VPtTestCont->ParAMatPatternLineNb[0] = 928;
      VPtTestCont->ParAMatPatternLineNb[1] = 928;
      VPtTestCont->ParAMatPatternLineNb[2] = 928;
      VPtTestCont->ParAMatPatternLineNb[3] = 928;
  ...
  if ( VJtag.IsBound () ) {
    ...
    for ( ViMaps=0; ViMaps < VPtTestCont->ParMapsNb; ViMaps++ ) {
      ...
      // --------------------------------------
      // Read Header & Trailer from JTAG conf
      // --------------------------------------
      ...
      // --------------------------------------
      // Build reference matrix from JTAG conf
      // --------------------------------------
      
      for ( ViRegLinePat=0; ViRegLinePat < ULT1__REG_DISCRI_W32_SZ; ViRegLinePat++ ) {
        OleCheck( VJtag.Mimosa28ConfGetLinePat0 ( (long) ViRegLinePat, (unsigned long*) &VPtTestCont->ParUlt1ALinePat0[ViMaps].AW32[ViRegLinePat], (unsigned long*) &VRegValFromMi26, &VStrComStatus ) );
        OleCheck( VJtag.Mimosa28ConfGetLinePat1 ( (long) ViRegLinePat, (unsigned long*) &VPtTestCont->ParUlt1ALinePat1[ViMaps].AW32[ViRegLinePat], (unsigned long*) &VRegValFromMi26, &VStrComStatus ) );
      }
      
      ULT1__FBuildMatDiscriW32FromLinePatReg ( &VPtTestCont->ParUlt1ALinePat0[ViMaps], &VPtTestCont->ParUlt1ALinePat1[ViMaps], &VPtTestCont->InfUlt1TmpMatW32 );
      ULT1__FMatDiscriConvW32ToBit ( &VPtTestCont->InfUlt1TmpMatW32, &VPtTestCont->InfUlt1AMatBitFromJtag[ViMaps] );
      
      ULT1__FMatDiscriPrintHit ( "Emulated matrix from JTAG" /* CmtStrTitle */, ViMaps /* CmtSInt8MapsId */, &VPtTestCont->InfUlt1AMatBitFromJtag[ViMaps] );
...
Rev       : 15/05/2013
          ...
          :
          : 31/01/14
          : - Bug fix on VPtTestCont->ResErrOnCurrentAcq handling
          :
Doc date  : 
Author    : Gilles CLAUS
E-mail    : gilles.claus@ires.in2p3.fr
...
SInt32 EFRIO__ULT1_FChkFrameLight ( SInt16 FuncId, SInt32 CurFrame, EFRIO__TFrame* PtFrame, SInt8 Mi26Nb ) {
  ...
  // err_error (( ERR_OUT, "TRACE : ParMapsNbToTest=%d - Mi26Nb=%d - VMi26Nb=%d", VPtTestCont->ParMapsNbToTest, Mi26Nb, VMi26Nb ));
  ...
  for ( ViMi26=0; ViMi26 < VMi26Nb; ViMi26++ ) {
    ...
    if ( VPtFrHd->AMapsFrameCnt[ViMi26] != VPtTestCont->InfMapsFrameCntRef ) {
      ...
      if ( VPtTestCont->ParPrintLvl == 1 ) {
        ...
        msg (( MSG_OUT, "Frame cnt error %s - %s : [Acq %.4d - Frame in Acq %.4d - Mi26 No %d] : Get %.6d - Must be %.6d ", TIME__FDateL2Str ( VDate, NULL, 0 ), TIME__FTime2Str  ( VTime, NULL, 0 ), VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsFrameCnt[ViMi26], VPtTestCont->InfMapsFrameCntRef ));
      }
    ...
    if ( VPtFrHd->AMapsHeader[ViMi26] != VPtTestCont->ParAMapsHeaderRef[ViMi26] ) {
      ...
      if ( VPtTestCont->ParPrintLvl == 1 ) {
        ...
        msg (( MSG_OUT, "Header error %s - %s : [Acq %.4d - Frame in Acq %.4dx - Mi26 No %d] : Get %8x - Must be %.8x ", TIME__FDateL2Str ( VDate, NULL, 0 ), TIME__FTime2Str  ( VTime, NULL, 0 ), VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsHeader[ViMi26], VPtTestCont->ParAMapsHeaderRef[ViMi26] ));
      }
    ...
    if ( VPtFrHd->AMapsTrailer[ViMi26] != VPtTestCont->ParAMapsTrailerRef[ViMi26] ) {
      ...
      if ( VPtTestCont->ParPrintLvl == 1 ) {
        ...
        msg (( MSG_OUT, "Trailer error %s - %s : [Acq %.4d - Frame in Acq %.4d - Mi26 No %d] : Get %8x - Must be %.8x ", TIME__FDateL2Str ( VDate, NULL, 0 ), TIME__FTime2Str  ( VTime, NULL, 0 ), VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsTrailer[ViMi26], VPtTestCont->ParAMapsTrailerRef[ViMi26] ));
      }
  ...
  // 31/01/14 Bug fix : Error status stored in ResErrOnCurrentAcq flag was cleared if one of the following MAPS has no error
  // The above line shows the code with bug
  // VPtTestCont->ResErrOnCurrentAcq = VErrors; // 25/04/2013
  
  VPtTestCont->ResErrOnCurrentAcq = VPtTestCont->ResErrOnCurrentAcq || VErrors;
...
:
Level     : This is a user level function.
Date      : 23/01/2014 ( DPXI version of 20/08/2009 moved here )
:
Rev       : 31/01/14
          : - Bug fix on VPtTestCont->ResErrOnCurrentAcq handling
          :
...
SInt32 EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailer ( SInt16 FuncId, EFRIO__TFrame* PtFrame, SInt16 CurFrame, SInt8 Mi26Nb, UInt32 FrameCntOfFirstFrameOfAcq ) {
  ...
  VPtTestCont->InfMapsFrameCntRef = FrameCntOfFirstFrameOfAcq + CurFrame; // 23/01/2014
  
  // err_error (( ERR_OUT, "TRACE => FrameCntOfFirstFrameOfAcq=%d - CurFrame=%d - InfMapsFrameCntRef = %d", FrameCntOfFirstFrameOfAcq, CurFrame, VPtTestCont->InfMapsFrameCntRef ));
  
//  if ( VPtTestCont->ParPrintLvl == 2 ) {
//    msg (( MSG_OUT, "FrameCntOfFirstFrameOfAcq=%d - CurFrame=%d - InfMapsFrameCntRef = %d", FrameCntOfFirstFrameOfAcq, CurFrame, VPtTestCont->InfMapsFrameCntRef ));
//  }
  
  for ( ViMi26=0; ViMi26 < VMi26Nb; ViMi26++ ) {
    
    // Check frame counter => Compare all Mimosa 28 frame counters to the frame counter (Mi28[0]) of first frame of acq + frame no
    ...
    if ( (VPtTestCont->ParPrintLvl == 3) || (VPtTestCont->ParPrintLvl == 6) ) {
      msg (( MSG_OUT, "Header [Acq %.4d - Frame in Acq %.4dx - Mi26 No %d] : Get %8x - Must be %.8x ", VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsHeader[ViMi26], VPtTestCont->ParAMapsHeaderRef[ViMi26] ));
    }
    
    
    // Print fames counter values
    
    if ( (VPtTestCont->ParPrintLvl == 4) || (VPtTestCont->ParPrintLvl == 6) ) {
      msg (( MSG_OUT, "FrameCntOfFirstFrameOfAcq=%d - CurFrame=%d - InfMapsFrameCntRef = %d", FrameCntOfFirstFrameOfAcq, CurFrame, VPtTestCont->InfMapsFrameCntRef ));
      msg (( MSG_OUT, "Frame cnt [Acq %.4d - Frame in Acq %.4d - Mi26 No %d] : Get %.6d - Must be %.6d ", VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsFrameCnt[ViMi26], VPtTestCont->InfMapsFrameCntRef ));
    }
    
    
    // Print trailers values
    
    if ( (VPtTestCont->ParPrintLvl == 5) || (VPtTestCont->ParPrintLvl == 6) ) {
      msg (( MSG_OUT, "Trailer [Acq %.4d - Frame in Acq %.4d - Mi26 No %d] : Get %8x - Must be %.8x ", VPtFrHd->AcqId, VPtFrHd->FrameIdInAcq, ViMi26, VPtFrHd->AMapsTrailer[ViMi26], VPtTestCont->ParAMapsTrailerRef[ViMi26] ));
    }
...
:
Level     : This is a user level function.
Date      : 24/01/2014 ( DPXI version of 20/08/2009 moved here )
:
Rev       : 31/01/14
          : - Bug fix on VPtTestCont->ResErrOnCurrentAcq handling
          :
...
SInt32 EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailerMatrix ( SInt16 FuncId, EFRIO__TFrame* PtFrame, SInt16 CurFrame, SInt8 Mi26Nb, UInt32 FrameCntOfFirstFrameOfAcq ) {
  ...
  static SInt8  VErrors;
  EFRIO__TFrameHeader* VPtFrHd;
  SInt32 VErrNbOnMatrix;
  
  ULT1__TZsFFrame* VUlt1APtZsFFRame[EFRIO__MAX_ASIC_NB];
  ...
  // msg (( MSG_OUT, "SIZE : ULT1__TZsFFrame=%d - ResUlt1AZsFFrame=%d", sizeof(ULT1__TZsFFrame), sizeof(VPtTestCont->ResUlt1AZsFFrame) ));
  ...
  for ( ViMi26=0; ViMi26 < Mi26Nb; ViMi26++ ) {
    VUlt1APtZsFFRame[ViMi26] = &VPtTestCont->ResUlt1AZsFFrame[ViMi26];
  }
  ...
  EFRIO__ULT1_FConvTFrameToZsFFrame ( PtFrame, VUlt1APtZsFFRame, 8 /* Mi28DestBuffersNb */, 0 /* PrintLevel */ );
  
  
  for ( ViMi26=0; ViMi26 < VMi26Nb; ViMi26++ ) {
  
    ULT1__FConvZsFFrameToMatDiscriBit ( VUlt1APtZsFFRame[ViMi26], &VPtTestCont->ResUlt1AMatBitFromDaq[ViMi26], NULL /* PtOvfCnt */, 0 /* PrintLvl */ );
  
    VErrNbOnMatrix = ULT1__FCompareMatDiscriBit ( VPtTestCont->ParAMatPatternLineNb[ViMi26] /* LineNbToCompare */, &VPtTestCont->ResUlt1AMatBitFromDaq[ViMi26] /* PtMat */, &VPtTestCont->InfUlt1AMatBitFromJtag[ViMi26] /* PtMatRef */, VPtTestCont->ParPrintLvl, ViMi26 /* PrintMimosaId */, PtFrame->Header.AcqId /* PrintAcqId */, PtFrame->Header.FrameIdInAcq /* PrintFrameId */ );
    
    if ( VErrNbOnMatrix != 0 ) {
      VPtTestCont->ResAMapsMatrixErrCnt[ViMi26] += VErrNbOnMatrix;
      ++VPtTestCont->ResAMapsErrCnt[ViMi26]; // Count ONLY one error if error(s) on matrix in order to avoid cumul counters ovf
      ++VPtTestCont->ResTotErrCnt;           // Count ONLY one error if error(s) on matrix in order to avoid cumul counters ovf
      VErrors = 1;
    }
  
    if ( VPtTestCont->ParPrintLvl == 7) {
        // 09/10/14 - MS : removed this function because it is not compatible with the ULT1 lib
      //ULT1__FMatDiscriPrintHit ( "Matrix from DAQ ", ViMi26 /* CmtSInt8MapsId */, &VPtTestCont->ResUlt1AMatBitFromDaq[ViMi26] );
    }
...
//  if ( 1 /* CurFrame % 10 == 0 */ ) {
//    EFRIO__ULT1_FConvTFrameToZsFFrame ( PtFrame, VUlt1APtZsFFRame, 8 /* Mi28DestBuffersNb */, 0 /* PrintLevel */ ); 
//    ULT1__FConvZsFFrameToMatDiscriBit ( VUlt1APtZsFFRame[0], &VPtTestCont->ResUlt1AMatBitFromDaq[0], NULL /* PtOvfCnt */, 0 /* PrintLvl */ );
//    ULT1__FMatDiscriPrintHit ( "Matrix from DAQ ", 0 /* CmtSInt8MapsId */, &VPtTestCont->ResUlt1AMatBitFromDaq[0] );
//  }
...
:
Level     : This is a user level function.
Date      : 30/01/2014 ( DPXI version of 20/08/2009 moved here )
          :
Rev       : 31/01/14
          : - Bug fix on VPtTestCont->ResErrOnCurrentAcq handling
          :
...
SInt32 EFRIO__ULT1_FChkFrameHeaderFrameCntCmpTrailerMatrix ( SInt16 FuncId, EFRIO__TFrame* PtFrame, SInt8 Mi26Nb ) {
  ...
  for ( ViMi26=0; ViMi26 < VMi26Nb; ViMi26++ ) {
    ...
    if ( VPtTestCont->ParPrintLvl == 7) {
        // 09/10/14 - MS removed this function because it is not compatible with the function of the ULT1 lib
      //ULT1__FMatDiscriPrintHit ( "Matrix from DAQ ", ViMi26 /* CmtSInt8MapsId */, &VPtTestCont->ResUlt1AMatBitFromDaq[ViMi26] );
    }
...
Rev       : 21/02/2011
          ...
          :
          : 29/10/2013
          : - Upgrade the code for Ult1, previous code was a copy of Mi26 code
          :
          : 30/01/2014
          : - Add data test options, selection done from DAQ GUI "Enable data test" list
          : -- 0 : No test
          : -- 1 : Light (H, FC compare,T)    => Test Header, Trailer, compare Frame Counter MAPS 0..7 but dont check increment
          : -- 2 : Basic (H, FC increment,T)  => Test Header, Trailer, check Frame Counter MAPS 0..7 increment during one Acq
          : -- 3 : Data  (Basic + Matrix)     => Basic test + Compare matrix data to expected pattern calculated from JTAG
          :
          : 01/02/2014
          : - Handle return value from header, frame counter, trailer, matrix data test functions
          :   => Don't increment RunCont.ResAcqCnt, ResFrameCnt, ResEventCnt in case of error(s)
          :         
Doc date  : 07/11/2010
Author    : Gilles CLAUS
E-mail    : gilles.claus@ires.in2p3.fr
...
SInt32 EFRIO__ULT1_FFRioAcqDeserDataEudet2Mode8Ult1 ( SInt32 BoardId, UInt32* PtSrcW32, SInt32 EltNb, SInt32 AcqStatus, SInt32 TrigStatus, SInt8 DataConvertMode, SInt8 TriggerHandlingMode ) {
  ...
  VFrameNbFromBoardDrv = ( EltNb / ULT1__ZS_FFRAME_MODE_2X160MHZ_W16_SZ ) / 9; // Divide by 9 because of extral channel
  ...
  for ( ViFrame=0; ViFrame < VPtBoard->FrameNbPerAcq; ViFrame++ ) {
    ...
    VPtEChanSrcW32 += 8; // Bypass Mi28 x 8 data
    ...
    ViSrcW32 += (9 * ULT1__ZS_FFRAME_RAW_MAX_W32);
    ...
    VPtFrame->Header.AMapsTrailer[0] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + (9 * VADataLengthW32[0])];    // 27 = 9 x 3 Fields nb before first data = Header, Frame cnt, Data length
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[1] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 1 + (9 * VADataLengthW32[1])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[2] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 2 + (9 * VADataLengthW32[2])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[3] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 3 + (9 * VADataLengthW32[3])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[4] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 4 + (9 * VADataLengthW32[4])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[5] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 5 + (9 * VADataLengthW32[5])];
    ++ViSrcW32;

    VPtFrame->Header.AMapsTrailer[6] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 6 + (9 * VADataLengthW32[6])];
    ++ViSrcW32;

    VPtFrame->Header.AMapsTrailer[7] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + 7 + (9 * VADataLengthW32[7])];
    ++ViSrcW32;
    ...
    if ( TrigStatus == 0 ) {
      VZero  = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + (9 * ULT1__ZS_FFRAME_RAW_MAX_W32) +  9]; // 9 = 9 x 1 Trailer
    }
    ...
    VZero2 = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9iFrame) + 27 + (9 * ULT1__ZS_FFRAME_RAW_MAX_W32) + 18]; // 18 = 9 x ( 1 Trailer + 1 Zero )
    ...
    switch ( VPtDataTest->ParTestType ) {
      ...
      case 8 : {
        VErrorsOnData = EFRIO__ULT1_FChkFrameLight ( 0 /* FuncId */ , ViFrame, VPtFrame, 8 /* Mi26Nb */ );
        VErrorsOnData = VErrorsOnData || EFRIO__ULT1_FCheckTFrame ( VPtFrame, 0 /* EmulErr */ );
        break; }
  ...
  // Update frames & events counters ONLY if there is no errors on data - 01/02/14
  ...
  if ( (VPtCont->RunCont.ResAcqCnt % 100) == 0  ) {
    
    VCDateTime = VCDateTime.CurrentDateTime ();
    VDate      = TIME__FConvDateTime2DateL ( VCDateTime );
    VTime      = TIME__FConvDateTime2Time  ( VCDateTime );
         
    msg (( MSG_OUT, "Run status %s - %s : %d Acq - %d Frames - %d Errors", TIME__FDateL2Str ( VDate, NULL, 0 ), TIME__FTime2Str  ( VTime, NULL, 0 ), VPtCont->RunCont.ResAcqCnt, VPtCont->RunCont.ResFrameCnt, VPtCont->TestOnDataCont.ResTotErrCnt ));
  }    
...
*/            
    ...
    switch ( VPtDataTest->ParTestType ) {
      ...
      case 1 : {
        VErrorsOnData = EFRIO__ULT1_FChkFrameLight ( 0 /* FuncId */ , ViFrameWithTrig, VPtFrame, 8 /* Mi26Nb */ );
        break; }
      
      case 2 : {
        VErrorsOnData = EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailer ( 0 /* FuncId */ , VPtFrame, ViFrameWithTrig, 8 /* Mi26Nb */, VPtFrList->AFramePtr[0]->Header.AMapsFrameCnt[0] /* FrameCntOfFirstFrameOfAcq */ ); // 23/01/2014 : For timing tests at lab
        break; }
      ...
      case 4 : {
        VErrorsOnData = EFRIO__ULT1_FChkFrameHeaderFrameCntIncTrailerMatrix ( 0 /* FuncId */ ,  VPtFrame, ViFrameWithTrig, 8 /* Mi26Nb */, VPtFrList->AFramePtr[0]->Header.AMapsFrameCnt[0] /* FrameCntOfFirstFrameOfAcq */ ); // 24/01/2014 : For timing tests at lab
        break; }
...
/* DOC_FUNC_BEGIN */
/* ===================================================================================
Prototype : SInt32 EFRIO__ULT1_FFRioAcqDeserDataEudet3Mode8Ult1__with_fw_bug_on_ext_chan (
          :   SInt32 BoardId , UInt32*  PtSrcW32, SInt32 EltNb,
          :   SInt32 AcqStatus, SInt32 TrigStatus,  SInt8 DataConvertMode )
          :
Warning ! : THIS VERSION HAS A BUG ON EXTRA CHANNEL HANLDING => ON TRIGGERS LIST
          : BUT the first three triggers stored in "zero fiels" are OK !!!!
          :
Goal      : Flex RIO readout function for six Mi26 in EUDET mode 3
          :
          : Read data of one acquisition from Flex RIO, format them in EUDET mode 3
...
Rev       : 30/12/2010
          ...
          :
          : 03/02/2014
          : - Bug fix : Trigger line calculation from zero fields, Mi28 has 32 clk / lines, not 16 line Mi26
          :
Doc date  : 07/11/2010
Author    : Gilles CLAUS
E-mail    : gilles.claus@ires.in2p3.fr
...
SInt32 EFRIO__ULT1_FFRioAcqDeserDataEudet3Mode8Ult1__with_fw_bug_on_ext_chan ( SInt32 BoardId, UInt32* PtSrcW32, SInt32 EltNb, SInt32 AcqStatus, SInt32 TrigStatus, SInt8 DataConvertMode, SInt8 TriggerHandlingMode ) {
  ...
  err_trace (( ERR_OUT, "EFRIO__ULT1_FFRioAcqDeserDataEudet3Mode8Ult1 (P=%x, EltNb=%d)", PtSrcW32, EltNb ));
...
// Frame with trigger search loop in case the is NO FW bug on trigger
  ...
  for ( VFrameId=0; VFrameId < VPtBoard->FrameNbPerAcq; VFrameId++ ) {
    ...
    if ( TrigStatus == 0 ) {
      VZero  = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + (9 * ULT1__ZS_FFRAME_RAW_MAX_W32) +  9]; // 27 = 9 x 3 Fields nb before first data = Header, Frame cnt, Data length
    }                                                                                                                  //  9 = 9 x 1 Trailer
    ...
    // BUT first read it from board RAM in order to get real execution time
      ...
      VZero  = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + (9 * ULT1__ZS_FFRAME_RAW_MAX_W32) +  9];
      VZero = (TrigStatus << 16);
    }
  ...
  */
  ...
  for ( ViFrameWithTrig=0; ViFrameWithTrig < VFrameWithTrigCnt; ViFrameWithTrig++ ) {
    ...
    VFrameId           = VPtFrameWithTrigList[ViFrameWithTrig];
    VEChanTrigFieldCnt = 0;
    ViSrcW32           = VFrameId * 9 * ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32;
    ...
    VPtFrame->Header.AMapsTrailer[0] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + (9 * VADataLengthW32[0])];    // 27 = 9 x 3 Fields nb before first data = Header, Frame cnt, Data length
    ++ViSrcW32;                                                                                                  
    
    VPtFrame->Header.AMapsTrailer[1] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 1 + (9 * VADataLengthW32[1])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[2] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 2 + (9 * VADataLengthW32[2])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[3] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 3 + (9 * VADataLengthW32[3])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[4] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 4 + (9 * VADataLengthW32[4])];
    ++ViSrcW32;
    
    VPtFrame->Header.AMapsTrailer[5] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 5 + (9 * VADataLengthW32[5])];
    ++ViSrcW32;

    VPtFrame->Header.AMapsTrailer[6] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 6 + (9 * VADataLengthW32[6])];
    ++ViSrcW32;

    VPtFrame->Header.AMapsTrailer[7] = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + 7 + (9 * VADataLengthW32[7])];
    ++ViSrcW32;
    ...
    VZero2 = PtSrcW32[(ULT1__ZS_FFRAME_RAW_TOTAL_SZ_W32 * V9FrameId) + 27 + (9 * ULT1__ZS_FFRAME_RAW_MAX_W32) + 18];
    ...
    if ( VTrigNb != 0 ) {
      ...
      // 03/02/14 Bug fix : Mi28 has 32 clk / line, not 16 like Mi26
...
Rev       : 30/12/2010
          ...
          : 03/02/2014
          : - Bug fix : Trigger line calculation from zero fields, Mi28 has 32 clk / lines, not 16 line Mi26         
          : - Mi28 Flex RIO FW bug on extra channel handling correction by SW
          :
Doc date  : 07/11/2010
Author    : Gilles CLAUS
E-mail    : gilles.claus@ires.in2p3.fr
...
SInt32 EFRIO__ULT1_FFRioAcqDeserDataEudet3Mode8Ult1 ( SInt32 BoardId, UInt32* PtSrcW32, SInt32 EltNb, SInt32 AcqStatus, SInt32 TrigStatus, SInt8 DataConvertMode, SInt8 TriggerHandlingMode ) {
  ...
  EFRIO__TFrame*           VPtFrame;
  EFRIO__TFrame*           VPtFrameMinus2; // 03/02/14 : Pointer two frames before VPtFrame to solve FW trigger bug
  ...
  UInt16               VAMi26Trig[3];
  EFRIO__TTriggerRec*  VPtTrigRec;
  EFRIO__TTriggerRec*  VPtTrigRecFrameMinus2; // 03/02/14
  UInt32               VFullFrameRecSz;
  UInt32               VEmptyFrameRecSz;
  UInt32               VEmptyTrigRecSz;
  SInt32               VDataLengthErrCnt;
  ...
  SInt32               VLastFrameWithTrig;
  SInt16*              VPtFrameWithTrigList;
  SInt16*              VPtFwTrigBugFrameWithTrigTrigNb;             // 03/02/14
  ...
  VPtFwTrigBugFrameWithTrigTrigNb = VPtCont->FwTrigBugAAAcqFrameWithTrigTrigNb[0];                         // 03/02/14 (09/06/2011)
  VPtFwTrigBugFrameWithTrigIsTrigListFrMinus2 = VPtCont->FwTrigBugAAAcqFrameWithTrigIsTrigListFrMinus2[0]; // 03/02/14 (09/06/2011)
  ...
  */
  ...
  for ( ViFrameWithTrig=0; ViFrameWithTrig < VFrameWithTrigCnt; ViFrameWithTrig++ ) {
    ...
    // 03/02/14 : Add trigger info in frame header
    
    // 03/02/14 : Test coherence of trigger nb list / current frame trigger nb info
  ...
  */
  ...
  if ( (VPtCont->RunCont.ResAcqCnt % 1000) == 0  ) {
...
SInt32 EFRIO__ULT1_FFRioAcqDeserDataUlt1 ( SInt8 Mi26Nb, SInt32 BoardId, UInt32* PtSrcW32AsPt, UInt32 PtSrcW32AsInt, SInt32 EltNb, SInt32 AcqStatus, SInt32 TrigStatus, UInt32 WaitMsAtEnd, SInt8 DataConvertMode, SInt8 TriggerHandlingMode, SInt16 EmuleMode, UInt32 DataTestTotErrCnt ) {
  ...
  // 31/01/14 Bug fix :
  // The bug fix is not here, it's done in data test functions on ResErrOnCurrentAcq handling
  // but NOW we must reset data test "error(s) on current acq flag" at beginning of each acquisition
  
  VPtTestCont->ResErrOnCurrentAcq = 0;
  ...
  while (1) {
    ...
    if ( DataConvertMode == EFRIO__TRF_MODE_EUDET_2__TRG_CHAN__SEND_ALL_FRAMES ) {
      ...
      switch ( Mi26Nb ) {
        ...
        case 8 : {
          // err_retfail ( -1, (ERR_OUT,"Abort : EFRIO__TRF_MODE_EUDET_2__TRG_CHAN__SEND_ALL_FRAMES -> This number of Mi28 = %d is not handled now", Mi26Nb ) );
    ...
    if ( DataConvertMode == EFRIO__TRF_MODE_EUDET_3__TRG_CHAN__SEND_FRAMES_WITH_TRIG ) {
      ...
      switch ( Mi26Nb ) {
        ...
        case 8 : {
          // err_retfail ( -1, (ERR_OUT,"Abort : EFRIO__TRF_MODE_EUDET_3__TRG_CHAN__SEND_FRAMES_WITH_TRIG -> This number of Mi28 = %d is not handled now", Mi26Nb ) );
...
SInt32 EFRIO__ULT1_FConvTFrameToZsFFrame ( EFRIO__TFrame* PtRec, ULT1__TZsFFrame* APtDest[EFRIO__MAX_ASIC_NB], SInt8 Mi28DestBuffersNb, SInt8 PrintLevel ) {
...
//  ULT1__TState         VState;
  ...
  ULT1__TStatesLine*   VPtStatesLine;
  ULT1__TState*        VPtState; // [ULT1__ZS_FFRAME_MAX_STATES_NB_PER_STATES_REC];
  ...
  // Check destination buffers nb
  
  if ( Mi28DestBuffersNb < VPtHead->MapsNb ) {
    err_retfail ( -1, (ERR_OUT,"Abort : Not enought destination Mi28 buffers : %d allocated / %d require", Mi28DestBuffersNb, VPtHead->MapsNb) );
  }
  
  // Check destination buffers allocation
  
  for ( ViMi26=0; ViMi26 < VPtHead->MapsNb; ViMi26++ ) {
    
    if ( APtDest[ViMi26] == NULL ) {
      err_retfail ( -1, (ERR_OUT,"Abort : Buffer [%d] for Mi28 not allocated (Ptr = NULL) !", ViMi26) );
    }
  ...
  // Copy header, trailer, etc ...

  for ( ViMi26=0; ViMi26 < VPtHead->MapsNb; ViMi26++ ) {
    
    memset ( APtDest[ViMi26], 0, sizeof (ULT1__TZsFFrameRaw) );
        
    APtDest[ViMi26]->SStatus.AsicNo          = ViMi26;
    APtDest[ViMi26]->SStatus.AcqNo           = PtRec->Header.AcqId;
    APtDest[ViMi26]->SStatus.FrameNoInAcq    = PtRec->Header.FrameIdInAcq;
    APtDest[ViMi26]->SStatus.FrameNoInRun    = 0; // => Not yet calculated !
    APtDest[ViMi26]->SStatus.HitCnt          = 0; // => Not yet calculated !
  
    APtDest[ViMi26]->SStatus.ATrigRes[ASIC__MI26_TRIG_RES__SIG_LINE] = PtRec->Header.AMapsTrigInfo[0];
    
                                            // ASIC__MI26_TRIG_RES__SIG_LINE
                                            // ASIC__MI26_TRIG_RES__SIG_CLK
                                            // ASIC__MI26_TRIG_RES__LINE
    
    APtDest[ViMi26]->Header          = PtRec->Header.AMapsHeader[ViMi26];
    APtDest[ViMi26]->FrameCnt        = PtRec->Header.AMapsFrameCnt[ViMi26];
    APtDest[ViMi26]->DataLength      = PtRec->Header.AMapsDataLength[ViMi26];
    APtDest[ViMi26]->TrigSignalLine  = PtRec->Header.AMapsTrigInfo[0];
    APtDest[ViMi26]->TrigSignalClk   = 0; // => Not yet calculated !
    APtDest[ViMi26]->TrigLine        = 0; // => Not yet calculated !
    APtDest[ViMi26]->Trailer         = PtRec->Header.AMapsTrailer[ViMi26];
    APtDest[ViMi26]->Zero            = 0; 
    APtDest[ViMi26]->Zero2           = 0; 
...
//    msg (( MSG_OUT, "===================================================================================" ));
    ...
    if ( VDataW16Length != 0 ) {
      ...
      // ViStatesLine  = 0; // 28/01/14 : Moved before loop, otherwise StatesRecNb was set with a random value after loop if VDataW16Length == 0 !!!
      
      while ( ViSrcW16 < VLastW16 ) { // Odd W16 nb handling => Don't process last W16                    
        
        VPtStatesLine = &APtDest[ViMi26]->AStatesRec[ViStatesLine].StatesLine;
        VPtState      = &APtDest[ViMi26]->AStatesRec[ViStatesLine].AStates[0]; // [ULT1__ZS_FFRAME_MAX_STATES_NB_PER_STATES_REC];
        
        // Copy StatesLine field
        
        VPtStatesLine->W16  = VPtSrcW16[ViSrcW16];
        VStatesNbPerLine    = VPtStatesLine->F.StateNb;
        
        // sprintf ( VStrLine, "Mi26 %2d Line %4d - %d state(s) - %d Ovf : ", ViMi26, VPtStatesLine->F.LineAddr, VPtStatesLine->F.StateNb, VPtStatesLine->F.Ovf );
        //
        // if ( (PrintLevel != 0) ) {
        ...
        for ( ViState=0; ViState < VStatesNbPerLine; ViState++ ) {
          VPtState[ViState].W16 = VPtSrcW16[ViSrcW16];
          
          // sprintf ( VStrState, "[Col %4d - %1d pixel(s)] ", VPtState[ViState].F.ColAddr, VPtState[ViState].F.HitNb + 1 );
          //
          // if ( (PrintLevel != 0) ) {
    ...
    APtDest[ViMi26]->StatesRecNb = ViStatesLine;
  ...
  // msg (( MSG_OUT, "$$$$$ Convert maxtrix exec time = %d [ms]", VTimeExecMs ));
...
SInt32 EFRIO__ULT1_FCheckTFrame ( EFRIO__TFrame* PtRec, SInt8 EmulErr ) {
  ...
  ULT1__TStatesLine    VStatesLine;
  SInt8                VStatesNbPerLine;
  UInt16               VStatesLineAddr;
   
  SInt16               ViMi26;  
  SInt8                VErrors;
   
  static UInt32        VEmulErrW16Cnt = 1;
...
/*
  ...
  for ( ViMi26=0; ViMi26 < VPtHead->MapsNb; ViMi26++ ) {
    ...
    APtDest[ViMi26]->SStatus.AcqNo           = PtRec->Header.AcqId;
    APtDest[ViMi26]->SStatus.FrameNoInAcq    = PtRec->Header.FrameIdInAcq;
    APtDest[ViMi26]->SStatus.FrameNoInRun    = 0; 
    APtDest[ViMi26]->SStatus.HitCnt          = 0; 
    ...
    APtDest[ViMi26]->DataLength      = PtRec->Header.AMapsDataLength[ViMi26];
    APtDest[ViMi26]->TrigSignalLine  = PtRec->Header.AMapsTrigInfo[0];
    APtDest[ViMi26]->TrigSignalClk   = 0; 
    APtDest[ViMi26]->TrigLine        = 0;
    APtDest[ViMi26]->Trailer         = PtRec->Header.AMapsTrailer[ViMi26];
    APtDest[ViMi26]->Zero            = 0;
    APtDest[ViMi26]->Zero2           = 0;
...
*/
  ...
  for ( ViMi26=0; ViMi26 < VPtHead->MapsNb ; ViMi26++ ) {
    ...
    VPtTestCont->ResAMapsMatrixHitCnt[ViMi26] = 0; // 06/02/14
    ...
    if ( VDataW16Length != 0 ) {
      ...
      while ( ViSrcW16 < VLastW16 ) { // Odd W16 nb handling => Don't process last W16
        ...
        if ( EmulErr ) {
          ...
          if ( (VEmulErrW16Cnt % 100000000) == 0 ) {
            msg (( MSG_OUT, "$$$ Error emulated ! Acq %d - Frame %d - MAPS[%d]", VPtHead->AcqId, VPtHead->FrameIdInAcq, ViMi26 ));
            VPtSrcW16[ViSrcW16] = 0xFFFF;
          }
        ...
        VStatesLineAddr  = VStatesLine.F.LineAddr;


        // msg (( MSG_OUT, "Frame %d : States/line nb = %d on MAPS[%d]", CurFrame, VStatesNbPerLine, ViMi26 ));
          
        if ( (VStatesNbPerLine == 0) || (VStatesNbPerLine > 9) || (VStatesLineAddr > 927) ) {
          msg (( MSG_OUT, "StateLine error ! Acq %d - Frame %d - MAPS[%d] : Bad number of states/line = %d OR LineAddr = %d on MAPS[%d] - Jump to next MAPS", VPtHead->AcqId, VPtHead->FrameIdInAcq, ViMi26 , VStatesNbPerLine, VStatesLineAddr ));
          ...
          break;          // => In order to exit while loop and jump to next Mi26
        }
        
        // 06/02/14
        
        VPtTestCont->ResAMapsMatrixHitCnt[ViMi26] += VStatesNbPerLine;
        
        // Bypass states readout => jump to next state/line word
        
        ViSrcW16 += (VStatesNbPerLine + 1);
