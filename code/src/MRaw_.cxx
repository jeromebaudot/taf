...
void MRaw::SitrineoAlign( Int_t nEvents, Bool_t order)
{
  ...
  Double_t z_dist_um[nPlanes] = {0, 1900, 2500, 2000}; // Distance between planes (w/ plane 1 as reference)
  ...
  //TF1 *fgausx[nPlanes]={fgaus1x, fgaus2x, fgaus3x, fgaus4x};
  ...
  //TF1 *fgausy[nPlanes]={fgaus1y->GetParameter(2), fgaus2y->GetParameter(2), fgaus3y->GetParameter(2), fgaus4y->GetParameter(2)};
  ...
  // Draw the ellipses on the first ccumulhit canvas
