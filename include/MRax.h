...
private:
 ...
 std::vector<Int_t>  configPlanesDrawOrder_default;
 std::vector<Char_t> configPlanesLeftRight_default;
 std::vector<Int_t>  configPlanesDrawOrder_custom1;
 std::vector<Char_t> configPlanesLeftRight_custom1;
...
private:
  ...
  //****************************************************************
public:
   Int_t DisplayTracksIn2D_Init(void);
   Int_t DisplayTracksIn2D_Show(Bool_t DrawTracks=1, Bool_t DrawSensors=1, Bool_t DrawTrackedHits=1, Bool_t DrawAllHits=1);
   Int_t DisplayTracksIn2D_Save(vector<TString> &vectorStringFilesExtensions);
   Int_t DisplayTracksIn2D_Reset(void);
   Int_t DisplayTracksIn2D_Kill(void);

private:
  Bool_t 		flagDisplayTracksIn2D_Init;
  TCanvas		*canvasDisplayTracksIn2D;
  TPaveLabel		*labelDisplayTracksIn2D;
  TPad			*padDisplayTracksIn2D;
  TH2I			**histoDisplayTracksIn2D_XZ;
  TH2I			**histoDisplayTracksIn2D_YZ;
  Double_t 		DisplayTracksIn2DViewLimitZmin,DisplayTracksIn2DViewLimitZmax;
  Double_t 		DisplayTracksIn2DViewLimitXmin,DisplayTracksIn2DViewLimitXmax;
  Double_t 		DisplayTracksIn2DViewLimitYmin,DisplayTracksIn2DViewLimitYmax;
  
  //****************************************************************
  //            Vertices Projections (obviously in Beam Frame [um])
  //****************************************************************
public:
  Int_t DisplayVerticesProjs_Init(void);
  Int_t DisplayVerticesProjs_Show(Bool_t DrawTarget=1);
  Int_t DisplayVerticesProjs_Save(vector<TString> &vectorStringFilesExtensions);
  Int_t DisplayVerticesProjs_Reset(void);
  Int_t DisplayVerticesProjs_Kill(void);

private:
  Bool_t                flagDisplayVerticesProjs_Init;
  TCanvas               *canvasDisplayVerticesProjs;
  TPaveLabel            *labelDisplayVerticesProjs;
  TPad                  *padDisplayVerticesProjs;
  TH1F                  **histoDisplayVerticesProjections;
  
  Double_t              confDisplayVerticesProjsImin,confDisplayVerticesProjsImax;
  Int_t                 confDisplayVerticesProjsIbin;
  Double_t              confDisplayVerticesProjsJmin,confDisplayVerticesProjsJmax;
  Int_t                 confDisplayVerticesProjsJbin;
  Double_t              confDisplayVerticesProjsKmin,confDisplayVerticesProjsKmax;
  Int_t                 confDisplayVerticesProjsKbin;
...
private:
  ...
  TPolyLine3D 		*lineBeamDisplayStrong, *lineBeamDisplayMedium, *lineBeamDisplayLight;
  ...
  Double_t 		coord_i[2],coord_j[2],coord_k[2];
...
private:
  ...
  TH1I                  *histoDisplayTracksAndTriggersProperties_TrackWithMemorizedHits;
  TH1I                  *histoDisplayTracksAndTriggersProperties_MemorizedHitsByTrack;
...
private:
 ...
 std::vector<Int_t>		vectorStatsAlongEvents_eventNb;
 std::vector< vector<Int_t> > vectorStatsAlongEvents_HitsNb;
 std::vector< vector<Int_t> > vectorStatsAlongEvents_OFlinesNb;
 std::vector<Int_t>		vectorStatsAlongEvents_nbOfTracks;
 std::vector<Int_t>		vectorStatsAlongEvents_nbOfTriggers;
...
public :
    struct trackStruct
    {
        ...
        DR3            TrackSlopeZ;
        Double_t       TrackChi2;
        Int_t          NbMemorizedHits;
        std::vector<DR3>    HitsPositions;
        std::vector<Int_t>  HitsPlanes;
        std::vector<Int_t>  HitsPixsNb;
        std::vector<Bool_t> HitsMemorized;
    };
    struct hitsStruct
    {
        std::vector<DR3>   HitsPositions;
...
private :
   ...
   std::vector<hitsStruct> hitsVector;

    trackStruct         aTrackStruct;
   std::vector<trackStruct> tracksVector;

    struct trackStructExportV20
    {
      Int_t    TracksNbInEvent;
      Double_t TrackOrigin_x;
      Double_t TrackOrigin_y;
			Double_t TrackOrigin_z;
			Double_t TrackSlope_x;
      Double_t TrackSlope_y;
			Double_t TrackSlope_z;
			Double_t TrackChi2;
      Int_t    TotalHitsNb;
      Int_t    MemorizedHitsNb;
			Int_t    CMOS_1L_PixInClust;
			Int_t    CMOS_2L_PixInClust;
			Int_t    CMOS_3L_PixInClust;
			Int_t    CMOS_4L_PixInClust;
			Int_t    CMOS_1R_PixInClust;
			Int_t    CMOS_2R_PixInClust;
			Int_t    CMOS_3R_PixInClust;
			Int_t    CMOS_4R_PixInClust;
      Bool_t   CMOS_1L_HitMemorized;
      Bool_t   CMOS_2L_HitMemorized;
      Bool_t   CMOS_3L_HitMemorized;
      Bool_t   CMOS_4L_HitMemorized;
      Bool_t   CMOS_1R_HitMemorized;
      Bool_t   CMOS_2R_HitMemorized;
      Bool_t   CMOS_3R_HitMemorized;
      Bool_t   CMOS_4R_HitMemorized;
    };
    trackStructExportV20	aTrackStructExportV20;
...
// From DSetup : struct IviGeometryParameter_t
...
//     Char_t	VertexingMethod[tpsz];
    ...
    DR3     Beam2points_ExperimentFrame[2];
    DR3     Track2points_TrackerFrame[2];
    DR3     Track2points_ExpermtFrame[2]; 	    
    DR3     Intersection;
    
    
    
    DPrecAlign  *frameChange_Expe2Tracker;
...
public :
    ...
    void  PrintCurrentEventNumber(void);
...
private :
    ...
    //                          / Tracks
    TGCheckButton *fTextButtonDisTracks_Cumul;
    //                                  / 3D View
    TGCheckButton *fTextButtonDisTracks3D, *fTextButtonDisTracks3D_DrawSensor,*fTextButtonDisTracks3D_DrawAllHits, *fTextButtonDisTracks3D_DrawTrackedHits, *fTextButtonDisTracks3D_DrawTracks;
    //                                  / 2D View
    TGCheckButton *fTextButtonDisTracks2D, *fTextButtonDisTracks2D_DrawSensor,*fTextButtonDisTracks2D_DrawAllHits, *fTextButtonDisTracks2D_DrawTrackedHits, *fTextButtonDisTracks2D_DrawTracks;
    //                          / Vertices
    TGCheckButton *fTextButtonDisVertices_Cumul;
    //                                  / 3D
    TGCheckButton *fTextButtonDisVertices3D, *fTextButtonDisVertices3D_DrawSensor, *fTextButtonDisVertices3D_DrawTracks, *fTextButtonDisVertices3D_DrawTrackDir, *fTextButtonDisVertices3D_DrawTarget;
    TGCheckButton *fTextButtonDisVertices3D_DrawBeam, *fTextButtonDisVertices3D_DrawVerticesPoints, *fTextButtonDisVertices3D_DrawVerticesPointsSmall, *fTextButtonDisVertices3D_DrawAcceptance;
    //                                  / 2D
    TGCheckButton *fTextButtonDisVerticesProjs, *fTextButtonDisVerticesProjs_DrawTarget;
    //                          / Statistics
    //                                  / CMOS
...
//
  ...
  //****************************************************************
private :
  void printf_info (const Char_t *text="");
  void printf_warning (const Char_t *text="");
  void printf_error(const Char_t *text="");
